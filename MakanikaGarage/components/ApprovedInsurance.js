...
class ApprovedInsurance extends React.Component {
        ...
        <ScrollView>
          {
          	...
          	this.props.insurances.filter((insurance) => insurance.status === "approved").map((insurances, i) => (
            <ListItem
              key={i}
...
export default connect(mapStateToProps, { getInsurancesAction })(ApprovedInsurance);