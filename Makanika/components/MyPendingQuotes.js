...
class MyPendingQuotes extends React.Component {
  ...
  render() {
    ...
    return (
      <SafeAreaView>
        <ScrollView>
          {this.props.quotations.filter((quotation) => quotation.status === "pending").map((quotation, i) => (
            <ListItem
              key={i}
...
export default connect( mapStateToProps, { getQuotations })(MyPendingQuotes);