...
class GetInsuranceQuotation extends React.Component {
  ...
  handleSubmit = () => {
    ...
    if (this.state.firstname && 
      ...
      const insuranceQuotationRequestBody = {
      ...
      this.props.postInsuranceQuotationAction(insuranceQuotationRequestBody, this.props.navigation.state.params.token);
...
export default connect(null, { postInsuranceQuotationAction })(GetInsuranceQuotation);
