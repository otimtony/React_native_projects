...
class InsuranceQuotations extends React.Component {
			...
			<ScrollView>
				{
					...
					this.props.quotations.filter(quotation => quotation.get_quotation === true ).map((quotation, i) => (
					<ListItem
						key={i}
						title={quotation.policy.policy_name}
						titleStyle={styles.policy_name}
						subtitle="Please wait for a quotation"
...
export default connect(mapStateToProps, { getQuotationsAction })(InsuranceQuotations);